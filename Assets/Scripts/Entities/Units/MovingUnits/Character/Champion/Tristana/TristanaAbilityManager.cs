public class TristanaAbilityManager : AbilityManager
{
    protected override void InitAbilities()
    {
        CharacterAbilities = new Ability[]
        {
            gameObject.AddComponent<Tristana_Q>(),
            gameObject.AddComponent<Tristana_W>(),
            gameObject.AddComponent<Tristana_E>(),
            gameObject.AddComponent<Tristana_R>()
        };
