public class VarusAbilityManager : CharacterAbilityManager
{
    ...
    {
        CharacterAbilities = new Ability[] { gameObject.AddComponent<Tristana_Q>(), gameObject.AddComponent<Varus_W>(), gameObject.AddComponent<Varus_E>(), gameObject.AddComponent<Varus_R>() };
