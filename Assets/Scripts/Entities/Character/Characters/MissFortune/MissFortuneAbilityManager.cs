public class MissFortuneAbilityManager : CharacterAbilityManager
{
    ...
    {
        CharacterAbilities = new Ability[] { gameObject.AddComponent<MissFortune_Q>(), gameObject.AddComponent<MissFortune_W>(), gameObject.AddComponent<MissFortune_E>(), gameObject.AddComponent<MissFortune_R>() };
