...
public class MissFortuneAbilityManager : CharacterAbilityManager
{
    ...
    {
        CharacterAbilities = new Ability[] { gameObject.AddComponent<Ezreal_Q>(), gameObject.AddComponent<MissFortune_W>(), gameObject.AddComponent<Ezreal_E>(), gameObject.AddComponent<Ezreal_R>() };
