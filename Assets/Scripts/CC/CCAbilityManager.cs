...
public class CCAbilityManager : CharacterAbilityManager
{
    ...
    {
        CharacterAbilities = new Ability[] { gameObject.AddComponent<MissFortune_Q>(), gameObject.AddComponent<CC_W>(), gameObject.AddComponent<MissFortune_E>(), gameObject.AddComponent<Lucian_R>() };
